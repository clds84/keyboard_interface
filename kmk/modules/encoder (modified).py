...
#     text_area5 = label.Label(terminalio.FONT, text=encoder5_text, scale=2, color=0xFFFF00, x=45, y=55)
#     splash.append(text_area5)
#     encoder_text= text1
#     text_area1 = label.Label(terminalio.FONT, text=encoder_text, scale=2, color=0xFFFF00, x=0, y=10)
#     splash.append(text_area1)
#     text2 = "llillo"
#     text_area2 = label.Label(terminalio.FONT, text=encoder2_text, scale=2, color=0xFFFF00, x=0, y=32)
#     splash.append(text_area2)
#     text_area3 = label.Label(terminalio.FONT, text=encoder3_text, scale=2, color=0xFFFF00, x=60, y=10)
#     splash.append(text_area3)
#     text4 = "hi"
#     text_area4 = label.Label(terminalio.FONT, text=encoder4_text, scale=2, color=0xFFFF00, x=57, y=32)
#     splash.append(text_area4)

    def on_button_do(self, keyboard, encoder_id, state):
        print('this is encoder 1')
...
#                 text5 = "HL Line"
#                 text_area5 = label.Label(terminalio.FONT, text=text5, scale=2, color=0xFFFF00, x=45, y=55)
#                 splash.append(text_area5)
#                 encoder_text= text1
#                 text_area1 = label.Label(terminalio.FONT, text=encoder_text, scale=2, color=0xFFFF00, x=0, y=10)
#                 splash.append(text_area1)
#                 text2 = "llillo"
#                 text_area2 = label.Label(terminalio.FONT, text=text2, scale=2, color=0xFFFF00, x=0, y=32)
#                 splash.append(text_area2)
#                 text_area3 = label.Label(terminalio.FONT, text=encoder3_text, scale=2, color=0xFFFF00, x=60, y=10)
#                 splash.append(text_area3)
#                 text4 = "hi"
...
#                 splash.append(text_area4)
                ...
                print('pressed encoder button and layer is:', layer)
...
#                 display.root_group = splash
#                 text = "HL Word"
#                 text_area  = label.Label(terminalio.FONT, text=text, scale=2, color=0xFFFF00, x=45, y=55)
